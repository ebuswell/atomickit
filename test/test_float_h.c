...
int run_float_h_test_suite() {
	...
	void (*ak_float_blank_tests[])()
		= { test_ak_float_init, test_atomic_float_is_lock_free,
		    NULL };
	char *ak_float_blank_test_names[]
		= { "ak_float_init", "atomic_float_is_lock_free", NULL };
	...
	void (*ak_double_blank_tests[])()
		= { test_ak_double_init, test_atomic_double_is_lock_free,
		    NULL };
	char *ak_double_blank_test_names[]
 		= { "ak_double_init", "atomic_double_is_lock_free", NULL };
